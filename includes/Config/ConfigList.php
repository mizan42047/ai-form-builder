<?php
namespace AIFormBuilder\Config;
...
abstract class ConfigList {
    ...
    private function set_active_list() {
        ...
        $database_list = get_option( 'aiformbuilder_' . $this->type . '_list', array() );
    ...
    private function sync_list_with_options() {
        $saved_list = get_option( 'aiformbuilder_' . $this->type . '_list', array() );
        ...
        update_option( 'aiformbuilder_' . $this->type . '_list', $saved_list );
    }
    ...
    public function save_list_to_options() {
        update_option( 'aiformbuilder_' . $this->type . '_list', $this->list );
    }
    ...
    public function load_list_from_options() {
        $this->list = get_option( 'aiformbuilder_' . $this->type . '_list', array() );
