...
class Enqueue {
    ...
    public function enqueue_block_editor_assets() {
        $this->register_and_enqueue_script(
            'ai-form-builder-controls',
            AIFORMBUILDER_PLUGIN_URL . 'build/controls/index.js',
            AIFORMBUILDER_PLUGIN_DIR . 'build/controls/index.asset.php'
        );

        $this->register_and_enqueue_script(
            'ai-form-builder-helpers',
            AIFORMBUILDER_PLUGIN_URL . 'build/helpers/index.js',
            AIFORMBUILDER_PLUGIN_DIR . 'build/helpers/index.asset.php'
        );

        $this->register_and_enqueue_script(
            'ai-form-builder-global',
            AIFORMBUILDER_PLUGIN_URL . 'build/global/index.js',
            AIFORMBUILDER_PLUGIN_DIR . 'build/global/index.asset.php'
        );
        
        $this->register_and_enqueue_style(
            'ai-form-builder-controls',
            AIFORMBUILDER_PLUGIN_URL . 'build/controls/index.css',
            AIFORMBUILDER_PLUGIN_VERSION
        );
    }
    ...
    public function enqueue_block_assets() {
        $this->register_and_enqueue_style(
            'ai-form-builder-global',
            AIFORMBUILDER_PLUGIN_URL . 'build/global/style-index.css',
            AIFORMBUILDER_PLUGIN_VERSION
        );
    }
