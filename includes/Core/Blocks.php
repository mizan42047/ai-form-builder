...
use AIFormBuilder\Config\BlocksList;
...
class Blocks
{
    ...
    public function register_blocks()
    {
        ...
        foreach ($active_blocks as $slug => $block) {
            $path = AIFORMBUILDER_BLOCKS_DIR . $slug;
    ...
    public function get_global_attributes()
    {
        ...
        $global_metadata_path = AIFORMBUILDER_PLUGIN_DIR . '/build/global/block.json';
    ...
    {
        if (!isset($metadata['name']) || !str_contains($metadata['name'], 'ai-form-builder')) {
            return $metadata;
        }
    ...
    {
        if (!isset($parsed_block['blockName']) || !str_contains($parsed_block['blockName'], 'ai-form-builder')) {
            return $parsed_block;
        }
